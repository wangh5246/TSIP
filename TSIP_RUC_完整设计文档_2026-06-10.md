...
论文 thesis 建议谨慎写成（系统名按命名决定用 WayBill）：

> WayBill is the first RUC design point that jointly supports zone-based charging, strong route privacy, and zero roadside enforcement infrastructure, at the cost of a stronger trusted receiver / odometer assumption.
