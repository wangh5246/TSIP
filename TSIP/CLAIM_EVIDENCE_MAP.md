...
| E05 | Experimental Setup | The execution-protocol paragraph identifies the source of RQ5 values. | Bind Figure 5 to the five prepared inputs, fixed protocol, and three seeds. | CE07 |
