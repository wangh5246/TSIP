...
- [[Experiments/M0-Canonical-Policy-Binding]]
- [[Experiments/M1-三层Fallback与双侧保证]]
- [[Experiments/M2-Tariff树深度与Fix规模]]
- [[Experiments/M3-E3求解器收敛与界]]
...
Managed block. Refresh with `/kb-sync` or `/kb-index`. Put hand-written navigation outside the markers below.
<!-- BEGIN AUTO INDEX -->
### Sources
- [[Sources/Docs/WayBill外部审阅报告-2026-07-13]]
- [[Sources/Docs/WayBill当前仓库审计-2026-07-13]]
